...
CREATE TABLE `SBML` (
  `idSBML` int(11) NOT NULL AUTO_INCREMENT,
  `output` varchar(45) DEFAULT NULL,
  `metabolites_cd_hash` varchar(45) DEFAULT NULL,
  `reaction_cd_hash` varchar(45) DEFAULT NULL,
  `ec` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idSBML`),
  KEY `index2` (`metabolites_cd_hash`),
  KEY `index3` (`reaction_cd_hash`),
  KEY `index4` (`ec`)
