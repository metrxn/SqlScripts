...
--
-- Table structure for table `FormulaChargeDistribution_2`
--

DROP TABLE IF EXISTS `FormulaChargeDistribution_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `FormulaChargeDistribution_2` (
  ...
  `smiles_charged_numbered` longtext,
  `smiles_charged_numbered_hash` varchar(200) DEFAULT NULL
...
-- Dump completed on 2014-02-08 23:51:45
